...
const MeetReportViewer = () => {
  ...
  // 👉 NUEVO: Función para mostrar fecha y hora en formato 24 hs
  ...
  const processDatos = (data) => {
    ...
    const resultado = Object.entries(grupos).map(([id, g]) => {
      ...
      return {
        ...
        materia: mat.materia,
        link,
        inicio: formatearFechaHora24(g.inicioMin), // 👈 Aplicado formato 24 hs
        fin: formatearFechaHora24(g.finMax), // 👈 Aplicado formato 24 hs
        duracion: `${horas}h ${mins}m`,
        participantes: g.participantes.size,
        codigoRaw: code,
        fechaInicio: g.inicioMin,
